...
<body>
    <main>
        <%--
        <fmt:formatNumber value="${value}" type="currency"/><br>
        <fmt:formatNumber value="${value}" pattern="0,000.0"/><br>
        <fmt:formatNumber value="${value}" pattern="0.000원"/><br>
        <fmt:formatNumber value="${value}" pattern="0.000개"/><br>
        <fmt:formatNumber value="${value2}" pattern="#,###.00개"/><br>
        <fmt:formatNumber value="${value}2" pattern="#,###.##개"/><br>
        ${value}
        --%>
        <h1>학사관리 대시보드 (School management dashboard)</h1>
            <div class="content_area">
                <div class="department_info">
                    ...
                    <p> 폐지 예전 : <span>${cnt.department[2]}건</span></p>
